  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Glass background */}
          <div className="absolute inset-0 bg-[var(--bg-glass)] backdrop-blur-2xl border border-[var(--accent-cyan)]/30 rounded-lg shadow-none overlay-glow overflow-hidden flex flex-col font-[family-name:var(--font-mono)] text-sm">
            ...
            <div className="flex items-center justify-between px-4 py-2 bg-[var(--accent-cyan)]/10 border-b border-[var(--accent-cyan)]/30 text-[var(--accent-cyan)]">
              ...
              <button onClick={() => setIsOpen(false)} className="hover:text-[var(--text-primary)] transition-colors">
                [X]
              </button>
            </div>
